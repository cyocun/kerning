...
let _ignoreAttr: string | undefined

function createSpotlight(): HTMLElement {
  const el = document.createElement('div')
  if (_ignoreAttr) el.setAttribute(_ignoreAttr, 'true')
...
function showClickRipple(x: number, y: number): void {
  ...
  if (_ignoreAttr) ripple.setAttribute(_ignoreAttr, 'true')
...
export function createTour(options: TourOptions): Tour {
  ...
  function showReplayButton() {
    ...
    if (_ignoreAttr) replayBtn.setAttribute(_ignoreAttr, 'true')
  ...
  function runTour() {
    ...
    if (_ignoreAttr) skipBtn.setAttribute(_ignoreAttr, 'true')
